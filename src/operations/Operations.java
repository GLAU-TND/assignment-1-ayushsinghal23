...
public class Operations {
    ...
    public void addContact(LinkedlistImplement linkedList1) {
    ...
    public void viewcontact(LinkedlistImplement linkedList1) {
    ...
    public void deleteContact(LinkedlistImplement linkedList1) {
        if (!linkedList1.isEmpty()) {
    ...
    public void searchContact(LinkedlistImplement linkedList1) {
